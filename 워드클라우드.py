import matplotlib.pyplot as plt # 시각화하는 도구
from wordcloud import WordCloud # wordcloud를 설치
from matplotlib import font_manager, rc
import platform


import pandas as pd
from collections import Counter #집약해서 보여줌 Counter 통해서 만들면 시각화 되는 타입이됨.
...
if os_name == 'Windows':
    font_path = r'C:\Windows\Fonts\malgunbd.ttf'  # 맑은 고딕 malgun.ttf / 역슬러시 앞에 r자 필요
...
rc('font', family=font_name) # rc 그래프 설정 폰트 설정
# 마이너스 기호 깨짐 방지
